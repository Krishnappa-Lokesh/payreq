		...
		onTheMasterPage: {
			...
			assertions: {
				...
				theListHeaderDisplaysZeroHits: function () {
					return this.waitFor({
						...
						matchers: new PropertyStrictEquals({
							name: "title",
							value: "ET_FV60HeaderSet (0)"
						}),
						success: function () {
							Opa5.assert.ok(true, "The list header displays 'ET_FV60HeaderSet (0)'");
						},
				...
				theListShouldHaveAllEntries: function () {
					...
					// retrieve all ET_FV60HeaderSet to be able to check for the total amount
					...
					return this.waitFor({
						...
						success: function (oList) {
							...
							this.waitFor({
								...
								matchers: new PropertyStrictEquals({
									name: "title",
									value: "ET_FV60HeaderSet (" + iExpectedLength + ")"
								}),
								success: function () {
