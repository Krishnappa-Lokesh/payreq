...
], function (jQuery, ObjectMarker, UploadCollectionParameter, MobileLibrary,
	FileSizeFormat, Device, BaseController, JSONModel, formatter, MessageBox, MessageToast) {
	"use strict";

	return BaseController.extend("appay.AP_PayRequest.controller.Detail", {
		...
		_onObjectMatched: function (oEvent) {
			...
			this.getModel().metadataLoaded().then(function () {
				var sObjectPath = this.getModel().createKey("ET_FV60HeaderSet", oParameter);
