sap.ui.define([
	...
	return UI5Object.extend("appay.AP_PayRequest.controller.ErrorHandler", {
		 ...
		 * @public
		 * @alias appay.AP_PayRequest.controller.ErrorHandler
		 */
		...
		_showServiceError: function (sDetails) {
			...
			MessageBox.error(aDetails["error"].innererror.errordetails[0].message, {
				...
				onClose: function () {
					//var oData = that._oModel.getData(oAppViewc.getProperty("/itemToSelect"));
					that._oModel.resetChanges();

					//var oAppViewc = that._oComponent.getRootControl().getModel("appView");
					//oAppViewc.setProperty("/addEnabled", false);
