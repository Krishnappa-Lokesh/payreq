sap.ui.define([
	...
	return BaseObject.extend("appay.AP_PayRequest.model.ListSelector", {
		 ...
		 * @class
		 * @public
		 * @alias appay.AP_PayRequest.model.ListSelector
		 */
		 ...
		 * @return {appay.AP_PayRequest.model.ListSelector} the list selector object for method chaining
		 * @public
		 */
